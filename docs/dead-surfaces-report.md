...
crates/ply-test-tests/tests/suite/unit/diagnose.rs:570:            trace: Tracing::Never,
```
...
> `crates/ply-test-tests/tests/suite/unit/diagnose.rs:570`, and the sentence read:
>
...
crates/ply-test-tests/tests/suite/unit/slice.rs:433   SliceBuilder::new()      its unit tests
crates/ply-test-tests/tests/suite/unit/slice.rs:485   SliceBuilder::with_cap(2) its unit tests

$ grep -rn 'Event::Perform(' --include='*.rs' . | grep -v '^\./target'
crates/ply-test/src/slice.rs:243             the match arm that consumes one
crates/ply-test-tests/tests/suite/unit/slice.rs:505   its unit test
```
...
> `slice.rs`'s unit tests (`ply-test-tests/tests/suite/unit/slice.rs`), and one inside its own `Default` impl
...
crates/ply-cli-tests/tests/suite/unit/commands/test.rs:540:        f["assertion"].is_null(),        # "the evaluator carries no payload yet"
crates/ply-cli-tests/tests/suite/unit/commands/test.rs:547:    assert!(f["causal_slice"].is_null(), "nothing traced this run");
crates/ply-cli-tests/tests/suite/unit/commands/test.rs:550:        f["footprint"]["observed"].is_null(),
crates/ply-test-tests/tests/suite/unit/runner.rs:1835:    assert!(failure.attribution.slice.is_none());
crates/ply-test-tests/tests/suite/unit/runner.rs:2010:    assert!(failure["causal_slice"].is_null());
crates/ply-test-tests/tests/suite/unit/runner.rs:2011:    assert!(failure["assertion"].is_null());
```
...
plus its unit tests in `ply-test-tests/tests/suite/unit/slice.rs`); `Attribution::slice` (`lib.rs:283`) and the
...
(`crates/ply-cli-tests/tests/suite/failure_classification_audit.rs:219-220`) in a scratch
directory:
...
the same fact `crates/ply-cli-tests/tests/suite/failure_classification_audit.rs:231` already
...
crates/ply-test-tests/tests/suite/unit/runner.rs:1359:        failure.diagnostic.message.contains("recursion limit"),
...
> `ply-test-tests/tests/suite/hybrid.rs`, `ply-test-tests/tests/suite/unit/runner.rs`, `ply-eval/src/tests.rs`)
...
`crates/ply-cli-tests/tests/suite/unit/commands/test.rs:540` (whose message *"the evaluator carries
no payload yet"* is a direct statement of this gap), and
`crates/ply-test-tests/tests/suite/unit/runner.rs:2011`.
...
>   there are 28, in `crates/ply-cli-tests/tests/suite/backend.rs`, asserting what happens
>   when it does.
>
...
```
  E0426  HOST_CONTINUATION_RESUMED   [*** NEW ***]
      ...
      test          crates/ply-cli-tests/tests/suite/w5_trace_audit.rs:310,
...
8. **`crates/ply-eval/src/limit.rs:80`'s correction block says four tests match
   ...
   `ply-test-tests/tests/suite/unit/runner.rs`, `ply-eval/src/tests.rs`)"* — names four files.
...
- **The trimmed-transcript probe** (§1.1, §2.1): run against a *copy* of
  `crates/ply-test-tests` with `tests/suite/unit/diagnose.rs:570` deleted, the probe called a
