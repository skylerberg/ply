...
use ply_compiler_diff::tokens::{byte_literal, floats_to_bits, records, reference_dump};
...
/// The lexer under test, which is the front end's own: `crates/ply-compiler/ply/lexer.ply`.
///
...
fn ply_dump(bytes: &[u8], label: &str) -> String {
    ...
    std::fs::write(
        dir.join("probe.ply"),
        format!(
            "// Generated by crates/ply-compiler-diff/tests/lexer_agreement.rs. Not checked in.\n\
             import lexer (dump)\n\n\
             fn source() -> Bytes = {}\n\n\
