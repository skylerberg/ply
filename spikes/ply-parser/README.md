...
| `infer.ply` | The checker: `infer.rs` ported, its first stage — declarations, signatures, every expression form, rows, tests and laws; `check_dump` publishes what `check_program` publishes. `GAPS.md` §17. |
