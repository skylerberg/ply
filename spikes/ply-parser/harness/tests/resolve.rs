...
use ply_parser_spike_harness::{byte_literal, programs, records, reference_resolve_dump};
...
impl Project {
    ...
    fn dumps(&self, inputs: &[Vec<(String, String)>]) -> Vec<String> {
        let mut src = String::from(
            "// Generated by spikes/ply-parser/harness/tests/resolve.rs. Not checked in.\n\
             import resolve (resolve_dump)\n",
        );
